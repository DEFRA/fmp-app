  ...
  it('test config values', () => {
    ...
    const expectedConfig = {
      ...
      agol: {
        ...
        surfaceWater1In30EndPoint: '/Surface_Water_Spatial_Planning_1_in_30_Depths_NON_PRODUCTION/FeatureServer/0',
        surfaceWater1In100EndPoint: '/Surface_Water_Spatial_Planning_1_in_100_Depths_NON_PRODUCTION/FeatureServer/0',
        surfaceWater1In1000EndPoint: '/Surface_Water_Spatial_Planning_1_in_1000_Depths_NON_PRODUCTION/FeatureServer/0',
  ...
  it('test config values in production', () => {
    ...
    const expectedConfig = {
      ...
      agol: {
        ...
        floodZonesClimateChangeEndPoint: '/Flood_Zones_2_and_3_Rivers_and_Sea_CCP1/FeatureServer/0',
        ...
        surfaceWater1In30EndPoint: '/Surface_Water_Spatial_Planning_1_in_30_Depths/FeatureServer/0',
        surfaceWater1In100EndPoint: '/Surface_Water_Spatial_Planning_1_in_100_Depths/FeatureServer/0',
        surfaceWater1In1000EndPoint: '/Surface_Water_Spatial_Planning_1_in_1000_Depths/FeatureServer/0',
