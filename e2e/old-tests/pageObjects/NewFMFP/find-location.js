...
class FindLocationPage {
  ...
  // get postcodeErrorMsg () { return $('#placeOrPostcode') }
  ...
  get skipToMapBtn () { return $('a=Skip to map') }

  /*
  get pageTitle403 () { return $('<h1>403 Forbidden</h1>') }

  async getPageTitle403 () {
    const element = await this.pageTitle403
  ...
  async skipToMap () {
    await (await this.skipToMapBtn).click()
  }
