...
describe('Privacy notice page', () => {
  ...
  it('navigates to the General Data Protection Regulation page when clicking the link @routing', async () => {
  ...
  it('navigates to the personal information charter page when clicking the link @routing', async () => {
  ...
  it('navigates to the web browser page when clicking the link @routing', async () => {
  ...
  // })
  it('navigates to the European Economic Area page when clicking the link @routing', async () => {
    await steps.clickLink(pages.privacyNotice.europeanEconomicAreaLink)
    await steps.expectUrlContains('eu-eea')
  })
  it('navigates to the access your data page when clicking the link @routing', async () => {
    await steps.clickLink(pages.privacyNotice.accessYourDataLink)
    await steps.expectUrlContains('data-protection')
  })
  it('navigates to the Information Commissioner’s Office page when clicking the link @routing', async () => {
  ...
  it('navigates to the GOV.UK Verify page when clicking the link @routing', async () => {
