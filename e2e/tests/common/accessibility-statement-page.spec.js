...
describe('Accessibility statement', () => {
  ...
  it('navigates to Ability Net page when clicking the link @routing', async () => {
    await steps.clickLink(pages.accessibilityStatement.abilityNetLink)
    await steps.expectUrlContains('abilitynet')
  })
  it('navigates to Equality Advisory page when clicking the link @routing', async () => {
  ...
  it('navigates to Web Content Accessibility Guidelines page when clicking the link @routing', async () => {
  ...
  it('navigates to full accessibility test report when clicking the link @routing', async () => {
