...
test.describe('Contact page', () => {
  ...
  test('navigates to check your details page after entering valid contact details and submitting', { tag: '@routing' }, async () => {
  ...
  test('shows validation error when submitting without entering details', { tag: '@validation' }, async () => {
    await steps.submit()
  ...
  invalidEmails.forEach((invalidEmail) => {
    test(`shows validation error when entering invalid email '${invalidEmail}' @validation @noDeps`, async () => {
      await steps.type(pages.contact.fullNameInput, 'Test User')
