...
lab.experiment('location', () => {
  ...
  lab.test(
    'location page returns 200 when requested with legacy place param  - expect this to be via redirect from confirm-location',
    async () => {
      const options = {
        method: 'GET',
  ...
  invalidPayloads.forEach(async (requestPayload) => {
    lab.test(
      `location page with placeOrPostcode: "${requestPayload.placeOrPostcode || 'undefined'}" should load /location view with errors`,
      async () => {
        const options = {
          method: 'POST',
          url: '/location',
        ...
        await payloadMatchTest(
          payload,
          /<span class="govuk-visually-hidden">Error:<\/span> Enter a real place name or postcode/g
        )
  ...
  findByAddressResponse.forEach((addressResponse) => {
    lab.test(
      `location page with placeOrPostcode and findByAddressResponse: "${JSON.stringify(addressResponse)}" should load /location view with errors`,
      async () => {
        const options = {
          method: 'POST',
          url: '/location',
        ...
        await payloadMatchTest(
          payload,
          /<span class="govuk-visually-hidden">Error:<\/span> No address found for that place or postcode/g
        )
        await payloadMatchTest(payload, /<a href="#placeOrPostcode">Enter a real place name or postcode<\/a>/g)
      }
    )
  ...
  lab.test(
    'location page with nationalGridReference and ngrResponse: "[{ isValid: false }]" should load /location view with errors',
    async () => {
      const options = {
        method: 'POST',
        url: '/location',
  ...
  lab.test(
    'location page findby eastingNorthing with missing easting and northing should should load /location view with errors',
    async () => {
      const options = {
        method: 'POST',
        url: '/location',
  ...
  lab.test(
    'location page findby eastingNorthing with invalid easting and northing should should load /location view with errors',
    async () => {
      const options = {
        method: 'POST',
        url: '/location',
      ...
      await payloadMatchTest(
        payload,
        /<span class="govuk-visually-hidden">Error:<\/span> Enter an easting in the correct format/g
      )
      await payloadMatchTest(
        payload,
        /<span class="govuk-visually-hidden">Error:<\/span> Enter a northing in the correct format/g
      )
  ...
  lab.test(
    'location page findby eastingNorthing with invalid easting should should load /location view with errors',
    async () => {
      const options = {
        method: 'POST',
        url: '/location',
  ...
  lab.test(
    'location page findby eastingNorthing with invalid northing should should load /location view with errors',
    async () => {
      const options = {
        method: 'POST',
        url: '/location',
