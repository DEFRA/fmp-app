...
lab.experiment('check-your-details', () => {
  ...
  lab.test(
    ...
    async () => {
      ...
      Code.expect(postParams.data).to.equal({
        payload:
          '{"x":360799,"y":388244,"polygon":"","location":"360799,388244","zoneNumber":13,"areaName":"Yorkshire","psoEmailAddress":"psoContact@example.com"}'
      })
    }
  )
  ...
  lab.test(
    ...
    async () => {
      ...
      Code.expect(postParams.data).to.equal({
        payload:
          '{"x":360799,"y":388244,"polygon":"[[[479614,484143],[479614,484143],[479692,484115],[479621,484081],[479583,484070],[479614,484143]]]","location":"Pickering","plotSize":"0.35","areaName":"Yorkshire","psoEmailAddress":"psoContact@example.com"}'
      })
    }
  )
  ...
  lab.test(
    ...
    async () => {
      ...
      Code.expect(postParams.data).to.equal({
        payload:
          '{"x":360799,"y":388244,"polygon":"","location":"360799,388244","areaName":"Yorkshire","psoEmailAddress":"psoContact@example.com"}'
      })
    }
  )
  ...
  lab.test(
    ...
    async () => {
      ...
      Code.expect(postParams.data).to.equal({
        payload:
          '{"x":360799,"y":388244,"polygon":"","location":"360799,388244","zoneNumber":10,"areaName":"East Anglia","psoEmailAddress":"enquiries_eastanglia@environment-agency.gov.uk"}'
      })
  ...
  lab.test(
    ...
    async () => {
      ...
      Code.expect(postParams.data).to.equal({
        payload:
          '{"x":360799,"y":388244,"polygon":"[[[479472,484194],[479467,484032],[479678,484015],[479691,484176],[479472,484194]]]","location":"360799,388244","plotSize":"3.49","areaName":"East Anglia","psoEmailAddress":"enquiries_eastanglia@environment-agency.gov.uk"}'
      })
      const { headers } = response
      Code.expect(headers.location).to.equal(
  ...
  lab.test(
    ...
    async () => {
      ...
      Code.expect(postParams.data).to.equal({
        payload:
          '{"x":12345,"y":678910,"polygon":"","location":"Pickering","areaName":"East Anglia","psoEmailAddress":"enquiries_eastanglia@environment-agency.gov.uk"}'
      })
  ...
  lab.test(
    ...
    async () => {
      ...
      Code.expect(postParams.data).to.equal({
        payload:
          '{"x":12345,"y":678910,"polygon":"[[[479472,484194],[479467,484032],[479678,484015],[479691,484176],[479472,484194]]]","location":"12345,678910","plotSize":"3.49","areaName":"East Anglia","psoEmailAddress":"enquiries_eastanglia@environment-agency.gov.uk"}'
      })
      const { headers } = response
      Code.expect(headers.location).to.equal(
