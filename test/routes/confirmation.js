...
lab.experiment('confirmation', () => {
      ...
      lab.test(
        ...
        async () => {
          ...
          await payloadMatchTest(
            payload,
            /<a href="\/flood-zone-results\?easting=12345&northing=67890&location=12345,67890">Go back to your flood information<\/a>/g
          )
  ...
  lab.test('confirmation with a polygon should contain a url to flood-zone-results with that polygon', async () => {
    ...
    await payloadMatchTest(
      payload,
      /<a href="\/flood-zone-results\?location=479643,484215&polygon=\[\[479536,484410\],\[479425,484191\],\[479785,484020\],\[479861,484314\],\[479536,484410\]\]&center=\[479643,484215\]">Go back to your flood information<\/a>/g
    )
  })
