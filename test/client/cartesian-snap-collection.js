...
lab.experiment('CartesianSnapCollection', () => {
  ...
  lab.test(
    'After calling setExtents for a contained range, cartesianSnapCollection.add should not be called ',
    async () => {
      cartesianSnapCollection.setExtents([10, 10], [12, 12])
  ...
  lab.test(
    'After calling setExtents for a non contained range, cartesianSnapCollection should contain the new Range ',
    async () => {
      cartesianSnapCollection.setExtents([10, 10], [12, 12])
  ...
  lab.test(
    'After calling setExtents for a partially contained range, cartesianSnapCollection should contain the points not already included ',
    async () => {
      cartesianSnapCollection.setExtents([10, 10], [12, 12])
  ...
  lab.test(
    'After calling setExtents for a range, within the extents of existing ranges, the new range should be added ',
    async () => {
      cartesianSnapCollection.setExtents([10, 10], [12, 12])
  ...
  lab.test(
    'cartesianSnapCollection test adding a new range that is entirely within a combination of ranges, but no single one',
    async () => {
