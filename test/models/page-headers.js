module.exports = {
  ...
  home: {
    standard: '<h1 class="heading-xlarge">Development planning and flood risk</h1>',
  ...
  summary: {
    standard: '<h1 class="heading-xlarge">Flood risk summary</h1>',
  ...
  'not-england': {
    standard: '<h1 class="heading-xlarge">We provide flood risk information for England only</h1>'
  }
}
