...
describe('About Page', () => {
  ...
  it('/about page should contain version numbers as expected', async () => {
    ...
    expectedContent('#fmp-app-version', 'Version: v3.0.0-1')
    expectedContent('#fmp-app-revision', 'Revision: 9256171')
    expectedContent('#fmp-app-type', 'internal')
    expectedContent('#fmp-api-version', 'Version: v8.8.8')
    expectedContent('#fmp-api-revision', 'Revision: 9988776')
  ...
  it('/about page should contain version numbers as expected when a tag build', async () => {
    ...
    await submitGetRequest({ url }, 'Flood map for planning')
    expectedContent('#fmp-app-version', 'Version: 3.0.0')
    expectedContent('#fmp-app-revision', 'Revision: 9256171')
    expectedContent('#fmp-app-type', 'internal')
    expectedContent('#fmp-api-version', 'Version: v8.8.8')
    expectedContent('#fmp-api-revision', 'Revision: 9988776')
  ...
  it('/about page should contain version numbers as expected when api is not available', async () => {
    ...
    expectedContent('#fmp-app-revision', 'Revision: 9256171')
    expectedContent('#fmp-app-type', 'internal')
    expectedContent('#fmp-api-version', 'Version: not available')
    expectedContent('#fmp-api-revision', 'Revision: not available')
    expectedContent('#environment', 'not available')
  })
  ...
  it('/about page should contain version numbers as expected when api returns nothing', async () => {
    ...
    expectedContent('#fmp-app-revision', 'Revision: 9256171')
    expectedContent('#fmp-app-type', 'internal')
    expectedContent('#fmp-api-version', 'Version:')
    expectedContent('#fmp-api-revision', 'Revision:')
