    ...
    handler: async (request, h) => {
      try {
        if (request.query.recipientemail && request.query.fullName && request.query.applicationReferenceNumber && request.query.location) {
          ...
          await emailConfirm.emailConfirmation(request.query.fullName, request.query.applicationReferenceNumber,
            model.location, model.AreaName, model.psoEmailAddress, model.recipientemail, model.search, model.zoneNumber)
