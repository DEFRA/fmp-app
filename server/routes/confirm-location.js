  ...
  options: {
    ...
    handler: async (request, h) => {
      ...
      try {
        ...
        const model = new ConfirmLocationViewModel(point.easting, point.northing, polygon, location, point.placeOrPostcode, recipientemail, fullName, locationDetails, contactDetails)
