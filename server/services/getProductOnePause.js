const { formatUKLongDateTime } = require('@defra/fmp-utilities/dates')
...
const getProductOnePause = async (pauseP1URL) => {
  try {
    ...
    const dateWithinPausePeriod = pauseP1DownloadFrom
      ...
      : false
    return {
      pauseP1DownloadTo: pauseP1DownloadTo && pauseP1DownloadFrom ? formatUKLongDateTime(pauseP1DownloadTo) : null,
