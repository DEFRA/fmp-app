...
const getSurfaceWaterClimateChange = async (options) => {
  const surfaceWaterClimateChange1In30 = esriFeatureRequest(config.agol.surfaceWaterClimateChange1In30EndPoint, makePolygonGeometry(options.polygon), 'esriGeometryPolygon')
  ...
  const surfaceWaterClimateChange1In100 = esriFeatureRequest(config.agol.surfaceWaterClimateChange1In100EndPoint, makePolygonGeometry(options.polygon), 'esriGeometryPolygon')
  ...
  const surfaceWaterClimateChange1In1000 = esriFeatureRequest(config.agol.surfaceWaterClimateChange1In1000EndPoint, makePolygonGeometry(options.polygon), 'esriGeometryPolygon')
